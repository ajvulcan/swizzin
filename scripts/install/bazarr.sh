...
echo "Clonando a '/home/${user}/bazarr'"
git clone https://github.com/morpheus65535/bazarr.git > $log 2>&1
chown -R ${user}: bazarr
cd bazarr
echo "Comprobando dependencias de pythons"
...
if [[ -f /install/.nginx.lock ]]; then
  ...
  echo "Por favor asegúrate que durante el asistente de bazarr la baseurl está establecida en: /bazarr/"
else
