...
function _install_wg () {
	...
	if [[ $? != "0" ]]; then
		echo "No se pudo hacer modprobe a Wireguard, saliendo del script..."
		echo "Por favor consulta el log."
		exit 1
	fi
...
echo
echo "EL código de configuración QR puede ser generado con el comando siguiente:"
